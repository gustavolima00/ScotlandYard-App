...
export default class Button2 extends Component {
    render(){
        ...
        return (
            <TouchableOpacity style={[container.button_2, { height:_height, width:_width }]} onPress={this.props.onPress}>
                <Text style={[text.button_2, {fontSize:_fontSize}]}> { this.props.value } </Text>
            </TouchableOpacity>
        )
    }
}